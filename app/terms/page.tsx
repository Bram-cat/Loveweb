...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Cosmic Background */}
      <div className="fixed inset-0 cosmic-bg"></div>
      <div className="fixed inset-0 bg-gradient-to-br from-pink-500/10 via-purple-600/10 to-indigo-700/10"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pb-20">
          ...
          <Card className="glass border-white/10">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-white font-semibold mb-2">By You</h3>
                  <p className="text-gray-300 text-sm">
                    You may cancel your account at any time through your dashboard or by contacting support.
                  </p>
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-2">By Us</h3>
                  <p className="text-gray-300 text-sm">
        ...
        >
          <Card className="glass border-white/10">
            <CardHeader>
              <CardTitle className="text-white text-xl">Governing Law</CardTitle>
            </CardHeader>
            <CardContent>
