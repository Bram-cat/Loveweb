              ...
              <Card className="glass border-white/15 bg-white/8 backdrop-blur-lg sticky top-6 card-glow">
                ...
                <CardContent className="space-y-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-between gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 text-gray-400 hover:text-gray-300 border border-white/5 hover:border-white/10 w-full"
                  >
