      ...
      default:
        return {
          ...
          features: [
            ...
            '50 Love Match analyses per month',
      ...
      <nav className="relative z-10 p-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          >
            ...
            <span className="text-2xl font-bold text-white">Lovelock</span>
          </motion.div>

          <div className="flex items-center space-x-4">
            <SignInButton mode="modal">
              <button className="backdrop-blur-sm bg-white/10 px-6 py-2 rounded-lg text-white hover:bg-white/20 transition-all border border-white/20">
                Sign In
              </button>
            </SignInButton>
          </div>
      ...
      <div className="relative z-10 px-6 py-20 flex items-center justify-center min-h-[calc(100vh-160px)]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="backdrop-blur-sm bg-white/10 border border-yellow-500/30 p-6 rounded-2xl mb-8"
          >
          ...
          <motion.div
            ...
            className="backdrop-blur-sm bg-white/10 border border-white/20 p-8 rounded-3xl mb-8"
          >
          ...
          {userInfo && (
            <motion.div
              ...
              className="backdrop-blur-sm bg-white/10 border border-white/20 p-6 rounded-2xl mb-8"
            >
          ...
          >
            <SignUpButton mode="modal">
              <button className={`w-full bg-gradient-to-r ${currentPlan.gradient} px-8 py-4 rounded-xl text-white font-semibold text-lg hover:shadow-2xl transition-all transform hover:scale-105 flex items-center justify-center space-x-2`}>
            ...
            <SignInButton mode="modal">
              <button className="w-full backdrop-blur-sm bg-white/10 border border-white/20 px-8 py-4 rounded-xl text-white font-semibold text-lg hover:bg-white/20 transition-all">
