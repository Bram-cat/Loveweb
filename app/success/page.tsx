      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          ...
          >
            ...
            {user && (
              <div className="backdrop-blur-sm bg-white/10 border border-white/20 p-6 rounded-2xl mb-8">
          ...
          >
            <button
              ...
              className="bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-4 rounded-xl text-white font-semibold text-lg hover:shadow-2xl transition-all transform hover:scale-105 flex items-center space-x-2"
            >
          ...
          <motion.div
            ...
            className="backdrop-blur-sm bg-white/10 border border-white/20 p-6 rounded-xl max-w-md mx-auto"
          >
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="backdrop-blur-sm bg-white/10 border border-white/20 p-6 rounded-2xl">
